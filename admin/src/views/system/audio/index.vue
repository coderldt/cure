        ...
        <el-col :span="24">
          <Table v-loading="isLoading" :column="tableColumn" :list="list" :total="total" @onPaginationChange="onPaginationChange">
            ...
            <template #control="{ row }">
              ...
              <el-popconfirm confirm-button-text="确认" cancel-button-text="取消" title="确认删除该音频?" @confirm="dele(row.id)">
                <template #reference>
...
import { getData, del } from "@/apis/sys/audio";
...
export default defineComponent({
  ...
  setup() {
    ...
    const tableColumn: TableColumn[] = [
      { label: "名字", prop: "name", width: "", align: "center" },
      { label: "图标", align: "center", slot: "logo" },
      { label: "音频地址", prop: "url", width: "", align: "center" },
